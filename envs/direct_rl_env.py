...
class DirectRLEnv(gym.Env):
    ...
    def step(self, action) -> VecEnvStepReturn:
        ...
        if isinstance(action, dict):
            action = {key: value.to(self.device) for key, value in action.items()}
    ...
    def _configure_gym_env_spaces(self):
        ...
        raise NotImplementedError(f"Please implement the '_configure_gym_env_spaces' method for {self.__class__.__name__}.")
